class HarvestPlan{
  ...
  factory HarvestPlan.fromJson(Map<String, dynamic>json){
    return HarvestPlan(crop: json['crop'], method: json['method'], season: json['season'], quantity: json['quantity'].toDouble(), equipment: json['equipment'], labor: json['labor'].toInt(), storage: json['storage'], harvestingdate: json['harvestingdate'].toDate());
  }
